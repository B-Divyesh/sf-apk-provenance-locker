...
Checked 2026-08-29. Counts treat hyphenated terms and file names as one word.
...
| Open the APK. | 3 | — |
| Android shows the final install decision. | 6 | — |
| This build uses a release-specific test key for direct sideloading. | 10 | — |
| It is not on Google Play. | 6 | — |

No sentence exceeds 22 words or uses a banned word.
